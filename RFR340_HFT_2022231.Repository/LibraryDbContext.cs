    ...
    public class LibraryDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Rent>().HasData(new Rent[]
                    {
                        new Rent("200#1346#3671#2022.02.13#2022.05.16"),
                        new Rent("201#1346#3671#2022.02.13#2022.05.16"),
                        new Rent("202#1346#3671#2022.02.13#2022.05.16"),
                        new Rent("203#1346#3671#2022.02.13#2022.05.16")
                    }
                );
